...
private slots:
    ...
    QString BuyBAC(QString OrderType, double Quantity, double Rate);
    QString SellBAC(QString OrderType, double Quantity, double Rate);
